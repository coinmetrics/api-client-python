...
if __name__ == '__main__':
    ...
    btc_1m_metrics = [metric['metric'] for metric in
                      client.catalog_asset_metrics_v2(assets=ASSET).to_list()[0]['metrics'] if
                      "1m" in [freq['frequency'] for freq in metric['frequencies']]]
    print("Exporting to single csv...")
    client.get_asset_metrics(
        assets="btc",
        metrics=btc_1m_metrics,
        frequency="1m",
        ...
        "./data_export/btc_1m_asset_metrics.csv"
    )
    ...
    client.get_asset_metrics(
        ...
        parallelize_on=["metrics"]
    ).export_to_csv_files("./data_export")
